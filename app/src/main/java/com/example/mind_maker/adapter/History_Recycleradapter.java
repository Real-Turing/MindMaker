...
public class History_Recycleradapter extends RecyclerView.Adapter<History_Recycleradapter.MyViewHolder> {
    ...
    public History_Recycleradapter(Context context, List<history> datas){
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        history da=mDatas.get(position);
